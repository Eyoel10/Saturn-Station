...
public class Tutorial : MonoBehaviour
{
    ...
    void TeachAsteroids()
    {
        ...
        isTutorialConditionMet = () => asteroid.transform.position.x < -x;
    ...
    void TeachBattery()
    {
        isTutorialConditionMet = () => !batteryPack.gameObject.activeInHierarchy || batteryPack.transform.position.x < -screenSizeWorld.x - 1.0f;
